 ...
 * "Warning: no file parameter, proceeding with default file ./edu.iastate.cs228.hw5.mazes/maze.10.10.50.txt";
 ...
 * Path length: 3
 * Path cost:  17
 * Path [3, 6, 9]vvvvvvvvvvvvvvvvvvvvvvvvvv
 * <p>
...
public class Maze {
    ...
    static public void main(String[] args) {
        ...
        if (args.length < 1 && !(new File("mazes")).exists()) {
            if ((new File("../edu.iastate.cs228.hw5.mazes")).exists()) {
                fname = "." + fname;
            }
        }
        if (args.length > 1) {
