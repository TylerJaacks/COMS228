...
/**
 * This interface is used only by Lexicon. The implementing methods are
 * already represented in the template (see LexiconImpl). The interface isn't important to
 * the correct functioning of your code, but your Lexicon must implement this
 * interface to facilitate automated grading. (Some edu.iastate.cs228.tests will replace your
